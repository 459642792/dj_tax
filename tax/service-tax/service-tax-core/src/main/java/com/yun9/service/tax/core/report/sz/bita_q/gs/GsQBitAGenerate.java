package com.yun9.service.tax.core.report.sz.bita_q.gs;
...
import com.yun9.service.tax.core.report.sz.bita_q.gs.report.*;
...
@ReportSnMapping(sns = "shenzhen_gs_q_bit_a")
public class GsQBitAGenerate implements IReportGenerate {
    ...
    public Map<String, List<ReportDataDTO>> generate(BizTaxInstanceCategory bizTaxInstanceCategory, JsonMap body) {
        ...
        return new HashMap() {{
            ...
            put("shenzhen_gs_q_bit_a_gdzcjszjmxb", ReportDataDTO.bulidReportDataDTO(new Report003().generate().toMap()));
            put("shenzhen_gs_q_bit_a_bzssrhsjljmynsssemxb", ReportDataDTO.bulidReportDataDTO(new Report004().generate(history).toMap()));
